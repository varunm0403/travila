    ...
    .then((data) => {
      ...
      data.items.forEach((video) => {
        ...
        videoContainer.className =
          "bg-gray-600 rounded-[32px] overflow-hidden h-48 md:h-[290px] transition-transform duration-500 delay-300 ease-in-out hover:scale-105 hover:shadow-xl";
            ...
            articles.forEach((article, index) => {
                ...
                faqItem.innerHTML = `
                    <section class="h-auto px-4 space-x-4 flex flex-row items-center justify-between border-b border-[#E4E6E8] border-[1px] p-8">
                        ...
                        <button class="faq-toggle-button min-w-[28px] md:w-[42px] h-[42px] rounded-[4px] bg-[#000000] flex justify-center items-center">
...
const apiKey1 = "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"; // Replace with your OpenRouter API key
